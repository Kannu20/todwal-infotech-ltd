    ...
    <section className="py-28 px-4 bg-gray-50 relative">
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          {steps.map((item, index) => (
            <motion.div
              ...
              className="relative bg-white border rounded-3xl p-8 text-center hover:-translate-y-2 hover:shadow-2xl transition-all duration-300"
            >
              <div className="absolute -top-5 left-1/2 -translate-x-1/2 bg-blue-600 text-white px-4 py-1 rounded-full text-sm font-bold shadow">
                Step {item.step}
              </div>

              <div className="w-16 h-16 flex items-center justify-center rounded-2xl bg-blue-50 text-blue-600 mx-auto mb-6 transition-transform duration-300">
                {item.icon}
              </div>
        ...
        >
          ...
          <a
            href="#contact"
            className="inline-flex items-center justify-center gap-2 bg-blue-600 text-white px-12 py-4 rounded-2xl font-semibold text-lg hover:bg-blue-700 transition shadow-lg hover:shadow-xl"
          >
