          ...
          {technologies.map((tech, index) => {
            ...
            return (
              <motion.div
                key={index}
                variants={cardVariants}
                className="group relative bg-gray-50 rounded-2xl p-8 border hover:-translate-y-2 hover:shadow-xl transition-all duration-300"
              >
                <div className="absolute inset-0 rounded-2xl ring-1 ring-blue-100 group-hover:ring-blue-300 transition" />

                <div className="relative w-14 h-14 bg-blue-600 text-white rounded-xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300">
                  <IconComponent size={26} />
                </div>
                ...
                <span className="relative inline-block text-sm font-medium text-blue-600 bg-blue-50 px-3 py-1 rounded-full">
                  {tech.highlight}
                </span>
              </motion.div>
            );
